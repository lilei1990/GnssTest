package com.example.demo.utils.cmd.generator;


import com.example.demo.utils.FileUtilsJava;
import com.example.demo.utils.cmd.Connector;
import com.example.demo.utils.cmd.Profile;
...
public class ProfileGenerator {
    ...
    public void genProfile() {
        ...
        while (true) {
            ...
            passwordList = FileUtilsJava.readLine(passwordPath, start, end);
...
class GenThread implements Runnable {
    ...
    public void run() {
        ...
        FileUtilsJava.writeToFile(Connector.PROFILE_TEMP_PATH + "\\" + password + ".xml", profileContent);
    }
}
