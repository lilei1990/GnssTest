...
object PropertiesLocalUtil {
    //val name = "src\\main\\resources\\user.properties"
    val name = "C:\\logs/${EnumProperties.COMPANY.defaultString}/user.properties"

   /* val TRACE_HISTORY_PATH = "trace_history_path"
    val UPDATE_FILE_PATH = "update_file_path"
    val UPLOAD_FILE_PATH = "upload_file_path"*/
    val TEST_MODEL = "TEST_MODEL"
    val USER_ID = "USER_ID"
    val EQUIPMENTID = "EQUIPMENTID"
    val UPLOAD_URL = "UPLOAD_URL"
