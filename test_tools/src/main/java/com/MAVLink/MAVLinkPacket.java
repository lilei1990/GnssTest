...
import com.MAVLink.MAVLink.common.*;
...
public class MAVLinkPacket implements Serializable {
     ...
     */
    public byte[] encodePacket(byte[] buffer) {
        int length = 6 + len + 2;
        if (buffer.length < length) {
            buffer = new byte[6 + len + 2];
        }
        int i = 0;
...
//        }
    ...
    public MAVLinkMessage unpack() {
        switch (msgid) {
            ...
            case msg_report_voltage.MAVLINK_MSG_ID_REPORT_VOLTAGE:
                return new msg_report_voltage(this);
            ...
            case msg_implement_cfg_notify.MAVLINK_MSG_ID_IMPLEMENT_CFG_NOTIFY:
                return new msg_implement_cfg_notify(this);

            case msg_implement_cfg_ack.MAVLINK_MSG_ID_IMPLEMENT_CFG_ACK:
                return new msg_implement_cfg_ack(this);

            case msg_imu_detail.MAVLINK_MSG_ID_IMU_DETAIL:
                return new msg_imu_detail(this);
            case msg_set_mode.MAVLINK_MSG_ID_SET_MODE:
                return new msg_set_mode(this);

            case msg_autopilot_stop_notification.MAVLINK_MSG_ID_AUTOPILOT_STOP_NOTIFICATION:
                return new msg_autopilot_stop_notification(this);

            case msg_autopilot_set_ab_req.MAVLINK_MSG_ID_AUTOPILOT_SET_AB_REQ:
                return new msg_autopilot_set_ab_req(this);

            case msg_autopilot_set_ab_rsp.MAVLINK_MSG_ID_AUTOPILOT_SET_AB_RSP:
                return new msg_autopilot_set_ab_rsp(this);

            case msg_gps_detail.MAVLINK_MSG_ID_GPS_DETAIL:
                return new msg_gps_detail(this);
            case msg_path_detail.MAVLINK_MSG_ID_PATH_DETAIL:
                return new msg_path_detail(this);
            case msg_motor_status.MAVLINK_MSG_ID_MOTOR_STATUS:
                return  new msg_motor_status(this);
                 
            case msg_gps_origin_msg.MAVLINK_MSG_ID_GPS_ORIGIN_MSG:
                return  new msg_gps_origin_msg(this);
                 
            case msg_params_request_read.MAVLINK_MSG_ID_PARAMS_REQUEST_READ:
                return new msg_params_request_read(this);
            ...
            case msg_single_antenna_test.MAVLINK_MSG_ID_SINGLE_ANTENNA_TEST:
                return new msg_single_antenna_test(this);
            ...
            case msg_params_value.MAVLINK_MSG_ID_PARAMS_VALUE:
                return new msg_params_value(this);

            case msg_params_set.MAVLINK_MSG_ID_PARAMS_SET:
                return new msg_params_set(this);

            case msg_angle_pid_tuning.MAVLINK_MSG_ID_ANGLE_PID_TUNING:
                return new msg_angle_pid_tuning(this);

            case msg_accel_pid_tuning.MAVLINK_MSG_ID_ACCEL_PID_TUNING:
                return new msg_accel_pid_tuning(this);
            ...
            case msg_nav_controller_output2.MAVLINK_MSG_ID_NAV_CONTROLLER_OUTPUT2:
                return new msg_nav_controller_output2(this);
            ...
            case msg_gps_raw_int_ex.MAVLINK_MSG_ID_GPS_RAW_INT_EX:
                return new msg_gps_raw_int_ex(this);
            ...
            case msg_command_ack_params.MAVLINK_MSG_ID_COMMAND_ACK_PARAMS:
                return new msg_command_ack_params(this);
            ...
            case msg_gps_cmd.MAVLINK_MSG_ID_GPS_CMD:
                return  new msg_gps_cmd(this);
            ...
            case msg_file_transfer_protocol_req.MAVLINK_MSG_ID_FILE_TRANSFER_PROTOCOL_REQ:
                return new msg_file_transfer_protocol_req(this);
            ...
            case msg_log_ekf1.MAVLINK_MSG_ID_LOG_EKF1:
                return new msg_log_ekf1(this);

            case msg_log_ekf2.MAVLINK_MSG_ID_LOG_EKF2:
                return new msg_log_ekf2(this);

            case msg_log_ekf3.MAVLINK_MSG_ID_LOG_EKF3:
                return new msg_log_ekf3(this);

            case msg_log_ekf4.MAVLINK_MSG_ID_LOG_EKF4:
                return  new msg_log_ekf4(this);
                 
            case msg_custom_command_data20.MAVLINK_MSG_ID_CUSTOM_COMMAND_DATA20:
                return  new msg_custom_command_data20(this);
                 
            case msg_custom_command_data40.MAVLINK_MSG_ID_CUSTOM_COMMAND_DATA40:
                return  new msg_custom_command_data40(this);
                 
            case msg_custom_command_data60.MAVLINK_MSG_ID_CUSTOM_COMMAND_DATA60:
                return  new msg_custom_command_data60(this);
                 
            case msg_custom_command_data80.MAVLINK_MSG_ID_CUSTOM_COMMAND_DATA80:
                return  new msg_custom_command_data80(this);
                 
            case msg_custom_command_data100.MAVLINK_MSG_ID_CUSTOM_COMMAND_DATA100:
                return  new msg_custom_command_data100(this);
                 
            case msg_custom_command_data120.MAVLINK_MSG_ID_CUSTOM_COMMAND_DATA120:
                return  new msg_custom_command_data120(this);
                 
            case msg_custom_command_data140.MAVLINK_MSG_ID_CUSTOM_COMMAND_DATA140:
                return  new msg_custom_command_data140(this);
                 
            case msg_custom_command_data160.MAVLINK_MSG_ID_CUSTOM_COMMAND_DATA160:
                return  new msg_custom_command_data160(this);
                 
            case msg_custom_command_data180.MAVLINK_MSG_ID_CUSTOM_COMMAND_DATA180:
                return  new msg_custom_command_data180(this);
                 
            case msg_custom_command_data200.MAVLINK_MSG_ID_CUSTOM_COMMAND_DATA200:
                return  new msg_custom_command_data200(this);
            ...
            case msg_angle_sensor_raw.MAVLINK_MSG_ID_ANGLE_SENSOR_RAW:
                return new msg_angle_sensor_raw(this);
